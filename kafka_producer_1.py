...
KAFKA_TOPIC_NAME_CONS = "PricingView"
...
if __name__ == "__main__":
    ...
    kafka_producer_obj = KafkaProducer(
        bootstrap_servers=['localhost:9092'], api_version=(
            0, 10, 0), value_serializer=lambda x: dumps(x).encode('utf-8')
    )
    ...
    ecommerce_website_name_list = ["www.data.com", "www.amazon.com", "www.flipkart.com", "www.snapdeal.com",
                                   "www.ebay.com"]
